 ...
 */
/*
    Much of the following is adapted from the Jasmine-Reporters project 
    The basic difference is that those reporters depended on PhantomJS 
    specific functionality, where as the Puppeteer approach is a little 
    cleaner in that the Jasmine results are just outputted to the console
    then written to a file. 
    This was built quickly to allow remote testing and reporting for my 
    projects.
 */
(function(global) {
    var UNDEFINED,
    ...
    exportObject.JUnitXmlReporter = function(options) {
        ...
        self.writeFile = function(filename, text) {
            ...
            function phantomWrite(path, filename, text) {
                ...
                // AMONIS: 08/12/2017: logging to console
        ...
        function generateFilename(suite) {
            ...
            return `${getFullyQualifiedSuiteName(suite, false)}.xml`;
        }
